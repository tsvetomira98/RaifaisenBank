 ...
 * @since 1.0.0
 */
class Realestate_Base_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'realestate_base';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'realestate-base' ), $i ),
...
// Initialize.
$realestate_base_footer_widgets = new Realestate_Base_Footer_Widgets();
