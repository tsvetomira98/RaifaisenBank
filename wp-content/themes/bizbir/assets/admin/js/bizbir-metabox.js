jQuery(function ($) {
	...
	var Bizbir_AdminMetaBox = {
		...
		cacheAll: function () {
			...
			$("#bizbir-metabox-tabs").tabs().addClass("ui-tabs-vertical ui-helper-clearfix");
			$("#bizbir-metabox-tabs li").removeClass("ui-corner-top").addClass("ui-corner-left");
		},
